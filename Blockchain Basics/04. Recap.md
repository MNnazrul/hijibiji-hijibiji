...
*P2P transactions: a payment is made directly from one person to another*  
...
**Pseudoanonimity :** Pseudonymisation is the process of replacing identifying information with random codes, which can be linked back to the original person with extra information.
...
*Immutability means it can't changed aafter deployed.*
